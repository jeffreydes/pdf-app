  ...
  return (
    <div className="min-h-screen bg-[#F8F9FA] text-[#111827] font-sans antialiased pb-32">
      ...
      <main className="max-w-3xl mx-auto pt-10 px-6">
        ...
        <div className="bg-white border border-gray-200/80 rounded-2xl p-5 shadow-sm mb-6 space-y-3">
          <span className="text-[10px] font-bold uppercase tracking-wider text-gray-400 block">Client & Timeline Details</span>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <input value={clientName} onChange={(e) => setClientName(e.target.value)} placeholder="Client Name" className="bg-gray-50 border border-gray-200 rounded-xl p-2 text-xs font-semibold outline-none focus:border-black" />
            <input value={clientCompany} onChange={(e) => setClientCompany(e.target.value)} placeholder="Client Company" className="bg-gray-50 border border-gray-200 rounded-xl p-2 text-xs outline-none focus:border-black" />
